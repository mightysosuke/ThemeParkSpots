...
ActiveRecord::Schema.define(version: 2020_01_08_123949) do
  ...
  create_table "areas", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.integer "park_id"
    t.string "name"
    t.datetime "created_at", null: false
  ...
  create_table "parks", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
